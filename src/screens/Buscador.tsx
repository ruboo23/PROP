...
export default function Buscador() {
    ...
    return (
        ...
        <View style={{ height: '100%' }}>
            <Text style={{ fontSize: 27, fontWeight: '700', marginTop: 20, marginHorizontal: 10 }}>Inspírate de tu entorno</Text>
            <Searchbar
                onChangeText={onSearchChange}
                value={searchInfo}

                style={{ marginVertical: 20, marginHorizontal: 10, backgroundColor: 'transparent', borderColor: 'black', borderWidth: 1, height: 50, alignContent: 'center' }}
            >
            </Searchbar>
